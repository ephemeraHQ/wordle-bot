...
* @returns {Uint8Array}
*/
export function user_preferences_encrypt(public_key, private_key, message) {
    try {
...
* @returns {Uint8Array}
*/
export function user_preferences_decrypt(public_key, private_key, message) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(public_key, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {string}
*/
export function generate_private_preferences_topic(private_key) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
